...
func TestGetInventoryByID(t *testing.T) {
	...
	if !reflect.DeepEqual(result, expectGetInventoryByIDResponse) {
		log.Fatalf("GetInventory by ID resp not as expected, expected: %v, resp result: %v", expectGetInventoryByIDResponse, result)
	}
...
func TestGetInventoryByName(t *testing.T) {
	...
	if err != nil {
		log.Fatalf("GetInventory by Name err: %s", err)
	}

	if !reflect.DeepEqual(result, expectGetInventoryByNameResponse) {
		log.Fatalf("GetInventory by Name resp not as expected, expected: %v, resp result: %v", expectGetInventoryByNameResponse, result)
	}

	log.Println("GetInventory by Name passed!")
}
